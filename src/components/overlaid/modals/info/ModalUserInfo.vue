...
export default class ModalUserInfo extends BasicOverlaid {
    ...
    get cpf() {
        return this.user.pessoa!.cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4')
    }
    get data_nascimento() {
        return moment(this.user.pessoa!.data_nascimento).format('DD/MM/YYYY')
    }
    get foto() {
